	...
	std::shared_ptr<PluginState> pluginState)
{
	...
	registerCheckboxSetting(persistentStorage, GoalPercentageCounterSettings::DisplayFlipResetPercentageDef, SET_BOOL_VALUE_FUNC(FlipResetPercentagShallBeDisplayed));
