...
const char* TriggerNames::ResetStatistics = "customtrainingstatistics_reset_statistics";
const char* TriggerNames::RestoreStatistics = "customtrainingstatistics_restore_statistics";
